...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png',140, 300, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png',170, 300, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 150, 470, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 760, 120, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 330, 410, 15, 30, 1),
  ...
  enemigos: [
     ...
     new ZombieCaminante('imagenes/zombie1.png', 490, 450, 10, 10, 1, {desdeX: 5, hastaX: 943, desdeY: 18, hastaY: 507}),
     new ZombieCaminante('imagenes/zombie2.png', 800, 420, 10, 10, 1, {desdeX: 5, hastaX: 943, desdeY: 18, hastaY: 507}),
     new ZombieCaminante('imagenes/zombie3.png', 600, 120, 10, 10, 1, {desdeX: 5, hastaX: 943, desdeY: 18, hastaY: 507}),
     new ZombieCaminante('imagenes/zombie4.png', 350, 250, 10, 10, 1, {desdeX: 5, hastaX: 943, desdeY: 18, hastaY: 507}),
     new ZombieCaminante('imagenes/zombie1.png', 120, 400, 10, 10, 1, {desdeX: 5, hastaX: 943, desdeY: 18, hastaY: 507}),
 
    new ZombieConductor('imagenes/tren_vertical.png', 644, 5, 30, 90, 5,{desdeX: 5, hastaX: 943, desdeY: 5, hastaY: 507}, 'v'),
    new ZombieConductor('imagenes/tren_vertical.png', 678, 5, 30, 90, 5,{desdeX: 5, hastaX: 943, desdeY: 5, hastaY: 507}, 'v'),
    new ZombieConductor('imagenes/tren_horizontal.png', 400, 322, 90, 30, 10,{desdeX: 5, hastaX: 943, desdeY: 18, hastaY: 507}, 'h'),
  ]
...
Juego.capturarMovimiento = function(tecla) {
  ...
  if (tecla == 'izq') {
    ...
    if(this.ultimaTecla != 'izq'&& this.ultimaTecla != 'der'){
      this.jugador.swapmedidas();
    }
    this.ultimaTecla = 'izq';
  }
  if (tecla == 'arriba') {
    movY = -velocidad;    
    this.jugador.sprite = 'imagenes/auto_rojo_arriba.png';
    if(this.ultimaTecla != 'arriba'&& this.ultimaTecla != 'abajo'){
      this.jugador.swapmedidas();
    }
    this.ultimaTecla = 'arriba';
  }
  if (tecla == 'der') {
    movX = velocidad;   
